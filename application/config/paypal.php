 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'booking_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? 'HBRKKNYSSMMKY5BX' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31ACPD5mdLwjocIY9WWuLFmACaOvKx' : 'PRODUCTION_SIGNATURE_GOES_HERE';
