...
<div class="midsection">
    <h4 class="font-thin m-l-md m-t" style="text-align: center; color: #449D44; ">
        My Freestyle Battles
    </h4>
...
// print_r($battleList);
    if ($this->session->flashdata('message')) {
        ?>
        <div class="alert <?php echo $this->session->flashdata('class') ?>" style="text-align: center; margin-top: 20px;">
            ...
            foreach ($battleList as $key => $value) {
                    ...
                    <div class="">
                        <div class="alert-info">
                            <small style="margin-left: 58px;">
                                ...
                                has challenged you to a Freestyle
                                <?php if($value['entry']>0) { echo ' Cash Battle for '.$value['entry'].'BB '; } else { echo ' Regular Battle '; } ?>
                                  to take place on <?=date('F d, \a\t g:ia',strtotime($value['date_time']))?>, 
                                  1BB will be deducted for the lease of the Freestyle beat, do you accept? 
                            </small>
              ...
              <?php } ?>
                ...
                <div class="col-md-12">
                    <div class="">
                         <h4 class="">
                             Freestyle battle will start on <?=date('F d, \a\t g:i a',strtotime($value['date_time']))?> 
                         </h4>
                    </div>
                </div>
                <?php } ?>
