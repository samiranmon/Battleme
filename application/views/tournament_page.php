...
$data_submit_2 = array(
    ...
    'type' => 'Submit',
    'class' => 'btn btn-s-xs',
    'style' => 'background:#2E75B5; color:#fff; margin-top: 15px;',
    'content' => 'Upload'
);
    ...
    <?php 
        ...
        <section class="panel panel-default scrollable"> 
            ...
            <section class="panel-body tourna">
                ...
                <?php echo form_open_multipart('tournament/entry_tournament/'.$tournament_details[0]['tournament_request_id'], $form_attr_2); ?>
                <div class="col-lg-12">
                    ...
                    <div class="form-group"> 
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div id="library_area" style="display: none">
                                <strong><a href="javascript:void(0)" data-toggle="modal" data-target="#myModal" class="btn btn-s-xs" style="background:#2E75B5; color:#fff;">Library</a></strong>
...
<?php
    ...
    if (isset($own_songs) && !empty($own_songs)) {
        foreach ($own_songs as $songKey => $songValue) {
                ...
                if($songValue['media'] != '' && file_exists(getcwd().'/'.$media)) { 
...
<script type="text/javascript">
    ...
    for (i = 0; i < sLan; i++) {
        var songCount = i + 1;
        $(".soundWidget ul").append("<li><span><input type='radio' name='media_id' id='demia_data_"+soundArr[i][2]+"' value='" + soundArr[i][2] + "' ></span><div class=audioleft><a href=javascript:void(0)>" + soundArr[i][1] + "</a></div><div class=audioright><audio><source src='" + soundArr[i][0] + "'  type=audio/mpeg></audio><button type=button class=Soundplay></button><button type=button class=Soundpause></button></div></li>");
    }
    var aud = new Audio();
    var pp;
