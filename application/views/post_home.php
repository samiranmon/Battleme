...
.current_link  {
    background: #2e75b5 none repeat scroll 0 0;
    margin: 2px 2px 0;
    padding: 6px;
    color: #fff;
}
...
<div class="midsection">
    ...
    <?php if (!empty($post_data)) {
        ...
        <?php } ?>
                    ...
                    <div class="pro_txt">
                        <?php if ($post['subject_id'] == $post['object_id']) {
                                if($post['shared_user_id'] != NULL) {
                                    $share_user = $this->Usermodel->getSingleUser($post['shared_user_id']);
                            ?>
                            <a href="<?php echo base_url('profile/view/' . $post['subject_id']); ?>">
                                <h5><?php echo $post['firstname'] . " " . $post['lastname']; ?> shared <?php echo ucfirst($share_user['firstname']) ?>'s post</h5>
                            </a> 
                                <?php } else { ?>
                                    <a href="<?php echo base_url('profile/view/' . $post['subject_id']); ?>">
                        ...
                        <?php } else { 
                            if($post['shared_user_id'] != NULL) {
                                    $share_user = $this->Usermodel->getSingleUser($post['shared_user_id']);
                            ?>
                            <a href="<?php echo base_url('profile/view/' . $userdata[0]->id); ?>">
                                <h5><?php echo $post['firstname'] . " " . $post['lastname']; ?> shared <?php echo ucfirst($share_user['firstname']) ?>'s post</h5>
                            </a>
                            <?php } else { ?>
                            <a href="<?php echo base_url('profile/view/' . $userdata[0]->id); ?>">
        ...
        <?php } ?>
                    ...
                    <div class="mshare">
                        <a href="<?php echo base_url('home/sharepost/'.$post['postid'].'/'. $post['subject_id'])?>"><img src="<?php echo base_url(); ?>public/images/share.png" alt="" > Share</a>
                    </div>
    ...
    <?php } ?>
    <!--<center><div class="pagination"><?//= $this->pagination->create_links() ?></div></center>-->
