    ...
    <div class="profile-lf-box plf-comn">
        ...
        <form id="profForm"  method="post">
            <div class="p-uploadimg-box">
                ...
                <img id="profContainer" src="<?php echo base_url() . 'uploads/profile_picture/' . $user_profile[0]->profile_picture; ?>" height="133px" width="132px" >
                <?php } else { ?>
                <img id="profContainer" src="<?php echo base_url(); ?>public/images/blank-img.png" alt="img">
                <?php } ?>
        ...
        <?php if ($user_id != $user_profile[0]->id) { ?>
            ...
            <?php if( $user_id !=  $user_profile[0]->id && $user_profile[0]->user_type == 'artist' && $user_session_data['user_type'] == 'artist' && isset($frnd_details[0]->active) && $frnd_details[0]->active == 1) { ?>
