...
<div class=" row">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
        ...
        <input name="membership_days" type="text" value="<?php echo $membership_days?>" class="form-control" id="membership_days" placeholder="Enter Membership Days">
    ...
    <div class="col-sm-10">
        <input name="membership_amount" type="text" value="<?php echo $membership_amount?>" class="form-control" id="membership_amount" placeholder="Enter Membership Amount">
