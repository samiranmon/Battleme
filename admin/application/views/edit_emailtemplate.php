...
<div class=" row">
 ...
 <?php if($this->session->flashdata('Success')) { ?>
            ...
            echo form_open_multipart('admin_dashboard/save_emailtemp_details' . '/' . $id, $attributes);
                ?>
<div class=" row">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
        ...
        <input type="text" class="form-control" name="emailname" placeholder="Enter Email Name" value="<?php echo $name; ?>">
    ...
    <div class="col-sm-10">
        ...
        <input type="text" class="form-control" name="emailsubject" placeholder="Enter Email Subject" value="<?php echo $subject; ?>">
    ...
    <div class="col-sm-10">
        <?php //echo $this->ckeditor->editor('emailcontent',@$content);?> <?php echo form_error('emailcontent','<p class="error">'); ?>
        <textarea name="emailcontent" ><?php echo $content;?></textarea>
    </div>
  </div>
        <div class="form-group">
