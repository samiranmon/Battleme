...
<div id="content" class="col-lg-10 col-sm-10" style=" min-height: 500px;">
    ...
    <div class=" row">
        ...
        echo form_open_multipart('admin_dashboard/save_contentmanage_details' . '/' . $id, $attributes);
        ?>
        <div class=" row">
            <div class="col-md-10 col-sm-10 col-xs-10">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="pagename" placeholder="Enter Page Name" value="<?php echo $pagename; ?>">
<?php echo form_error('pagename', '<div class="error">', '</div>'); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="pageurl" placeholder="Enter Page URL" value="<?php echo $pageurl; ?>">
...
<?php //echo $this->ckeditor->editor('pagecontent',@$pagecontent); ?> <?php echo form_error('description', '<p class="error">'); ?>
                        <textarea name="pagecontent" style="width:100%"><?php echo $pagecontent; ?>
                        </textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="metadescription" placeholder="Enter Meta Description" value="<?php echo $meta_description; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="metakeyword" placeholder="Enter Meta Keyword" value="<?php echo $meta_keyword; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="metaauthor" placeholder="Enter Meta Author" value="<?php echo $meta_author; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="other" placeholder="Enter Other Description" value="<?php echo $other; ?>">
