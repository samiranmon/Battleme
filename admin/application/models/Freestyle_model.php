...
class Freestyle_model extends CI_Model {
    ...
    **/
    ...
    public function deleteLibrary($id) {
        ...
        $libraryDtl = $this->getSingleLibrary($id);
         if($libraryDtl['media'] != '' && file_exists($getcwd.'/uploads/freestyle_library/'.$libraryDtl['media'])) {
             unlink($getcwd.'/uploads/freestyle_library/'.$libraryDtl['media']);
         }
         
         $deluser=$this->db->delete('freestyle_beat_library', array('id' => $id));
         if($deluser){
             return true;
         }else{
             return false;
     ...
     public function updateFreestyleLibrary($id,$data)
    {
                
        $this->db->where('id', $id);
        $this->db->update('freestyle_beat_library', $data);
        return true; 
     ...
     public function addFreestyleLibrary($data)
    {
                
        $this->db->insert('freestyle_beat_library', $data);
