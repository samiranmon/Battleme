        ...
        <div class="mainbdy">
            <div class="container">
                <div class="row">
                    ...
                    <?php if($middle != 'battle_categories_list') { ?>
                    <div class="col-sm-3">
                        <?php $this->load->view('home_sidebar'); ?>
                    </div>
                    <?php } ?>
                    
                    <div class="<?php if($middle != 'battle_categories_list') { echo 'col-md-9'; } else {echo 'col-md-12'; }?> mar_none">
                        <div class="row">
                            <div class="top_head">
...
<?php $this->load->view('right_sidebar'); ?>
                    ...
                    <div class="<?php if($middle != 'battle_categories_list') { echo 'col-md-9'; } else {echo 'col-md-12'; }?> right_content">
                        <div class="row">
